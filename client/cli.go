...
func (c *cliClient) newDraft(to *Contact, inReplyTo *InboxMessage) (*Draft) {
	draft := &Draft{
		id:      c.randId(),
		created: time.Now(),
		to:      to.id,
